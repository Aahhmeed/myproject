 ...
 <div class="container">
        <h3>للدخول في السحب اتبع ما يلي : </h3>
           ...
           <ul class="list-group list-group-flush">
                <li class="list-group-item">تابع البث المباشر على قناتي باليوتيوب بالتاريخ المذكور اعلاه </li>
                <li class="list-group-item">سأقوم ببث مباشر لمدة ساعة عبارة عن اسئلة وأجوبة حرة للجميع</li>
                <li class="list-group-item">خلال فترة الساعة سيتم فتح صفحة التسجيل هنا حيث تقوم بتسجيل اسمك وإيميلك </li>
...
<h1 class="display-3 text-center modal-title" id="modalLabel"> <?php echo htmlspecialchars($user ['fistName']) . ' '.  htmlspecialchars($user ['lastName'])?> </h1>
<?php endforeach; ?>        </div>
